...
export const createHalfPlaybackRateToggle = inlineComponent<{ playerController: PlayerController }>(controls => {
  let playbackRates: [number, number] = [1, 0.5],
  ...
  return inputs =>
    ...
    [`
      <button type="button" class="half-playback-rate-toggle_button${currentRate === 1 ? ' is-active' : ''}">
            0.5
          <!--
