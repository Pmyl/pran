...
export const createPauseButton = inlineComponentOld<{ playerController: PlayerController }>(controls => {
  ...
  return inputs =>
    ...
    `, e => onClick(e, '.pause-button_button', () => inputs.playerController.pause())];
});
